...
public class RoomManager {
	...
	public void init() {
		...
		Room diningRoom = new Room ("The Dining Room", 
				...
				+ "stands taking up most the space and under which cushioned wooden chairs sit."
		...
		Room bathRoomFloor1 = new Room ("The 1st Floor Bathroom",
				...
				+ "counter top and the refridgerator. Inside is a toilet, a sink, and small stained"
				+ "glass window near the ceiling.\n"
				+ "To the west is the narrow doorway leadign to the kitchen."
			);
		...
		Room bathRoomFloor2 = new Room ("The 2nd Floor Bathroom",
				...
				+ "holds a bathtub as well as a rack for towels. Shades mask a window looking out over the lawn.\n"
		...
		Room bedroom = new Room("The Master Bedroom", 
				...
				"The masterbedroom and where the building's owners sleep. Heavy curtains frame the windows and a "
				+ "television hangs on the wall across from the bed, above an antique looking dresser.\n"
